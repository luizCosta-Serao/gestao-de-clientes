    ...
    <div class="lista-pagamentos-concluidos">
      ...
      <div class="valores-tabela">
        <?php
          ...
          $pagamentosConcluidos = MySql::connect()->prepare("SELECT * FROM `financeiro` WHERE status = ? AND cliente_id = ? ORDER BY vencimento ASC");
          $pagamentosConcluidos->execute(array(1, $id));
